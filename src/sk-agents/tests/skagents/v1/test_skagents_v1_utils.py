...
from sk_agents.skagents.v1.utils import (
    ...
    get_token_usage_for_google_response,
...
class TestGetTokenUsageForResponse:
    ...
    def test_get_token_usage_for_google_response(self):
        """Test token usage extraction for Google responses."""
        content = MagicMock(spec=ChatMessageContent)
        content.inner_content = MagicMock()
        content.inner_content.usage = MagicMock()
...
class TestGetTokenUsageForGoogleResponse:
    """Test get_token_usage_for_google_response function."""

    def test_get_token_usage_for_google_response(self):
        """Test Google token usage calculation."""
        content = MagicMock(spec=ChatMessageContent)
        content.inner_content = MagicMock()
        content.inner_content.usage = MagicMock()
        content.inner_content.usage.output_tokens = 180
        content.inner_content.usage.input_tokens = 90

        result = get_token_usage_for_google_response(content)
