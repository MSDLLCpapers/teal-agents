...
def mock_kernel_builder():
    ...
    builder.build_kernel = AsyncMock()
...
class TestBuildAgent:
    ...
    @pytest.mark.asyncio
    @patch("sk_agents.tealagents.v1alpha1.agent_builder.ChatCompletionAgent")
    async def test_build_agent_with_all_parameters(
        ...
        # Execute
        with patch(
            "sk_agents.tealagents.v1alpha1.agent_builder.get_type_loader"
        ) as mock_get_type_loader:
            ...
            result = await builder.build_agent(agent_config, mock_extra_data_collector, output_type)
        ...
        assert hasattr(mock_settings.function_choice_behavior, "maximum_auto_invoke_attempts")
        assert mock_settings.function_choice_behavior.maximum_auto_invoke_attempts == 0
    ...
    @pytest.mark.asyncio
    @patch("sk_agents.tealagents.v1alpha1.agent_builder.ChatCompletionAgent")
    async def test_build_agent_minimal_config(
        ...
        # Execute
        result = await builder.build_agent(minimal_agent_config)
    ...
    @pytest.mark.asyncio
    @patch("sk_agents.tealagents.v1alpha1.agent_builder.ChatCompletionAgent")
    async def test_build_agent_with_temperature_only(
        self, mock_agent_class, mock_kernel_builder, minimal_agent_config
    ):
    ...
    @pytest.mark.asyncio
    @patch("sk_agents.tealagents.v1alpha1.agent_builder.ChatCompletionAgent")
    async def test_build_agent_with_max_tokens_only(
        self, mock_agent_class, mock_kernel_builder, minimal_agent_config
    ):
    ...
    @pytest.mark.asyncio
    @patch("sk_agents.tealagents.v1alpha1.agent_builder.ChatCompletionAgent")
    async def test_build_agent_so_supported_without_output_type(
        self, mock_agent_class, mock_kernel_builder, minimal_agent_config
    ):
        ...
        with patch(
            ...
            result = await builder.build_agent(minimal_agent_config, output_type=None)
    ...
    @pytest.mark.asyncio
    @patch("sk_agents.tealagents.v1alpha1.agent_builder.ChatCompletionAgent")
    async def test_build_agent_so_not_supported_with_output_type(
        self, mock_agent_class, mock_kernel_builder, minimal_agent_config
    ):
        ...
        with patch(
            ...
            result = await builder.build_agent(minimal_agent_config, output_type="SomeType")
    ...
    @pytest.mark.asyncio
    @patch("sk_agents.tealagents.v1alpha1.agent_builder.ChatCompletionAgent")
    async def test_build_agent_model_attributes(
        self, mock_agent_class, mock_kernel_builder, agent_config
    ):
        ...
        # Execute
        result = await builder.build_agent(agent_config)
    ...
    @pytest.mark.asyncio
    @patch("sk_agents.tealagents.v1alpha1.agent_builder.ChatCompletionAgent")
    async def test_build_agent_function_choice_behavior(
        self, mock_agent_class, mock_kernel_builder, minimal_agent_config
    ):
